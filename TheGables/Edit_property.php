      ...
      //-----------------------------------------------------------------------
        ...
        $description=mysqli_real_escape_string($connection,$description);
          ...
          if($process_delete!=""){
           ...
           $delete="DELETE FROM PropertyImage WHERE id=".$_POST['id'];
        ...
        if ($file_name!="") {
          foreach($paths as $path){
            $AddImage ="INSERT INTO PropertyImage(property_id,path)VALUES(".$_GET['id'].",'$path')";
      ...
      <form method="POST" id = "log">
        ...
        <div class="container" >
            ...
            <div id="Pimg">
                  ...
                  <input type="file" name="picture[]" class="Pinfo" style="font-family: Papyrus;" multiple>
                  </label><br>
                </div>
              ...
              <?php foreach($images as $image){ ?>
                ...
                <span class="Vimg">
                    ...
                    <form action="deleteImage.php" method="post">
                      <input type="hidden" name="porperty_id" value="<?php echo $Property['id']; ?>" />
                      <input type="hidden" name="id" value="<?php echo $image[0]; ?>" />
                      <button type="submit" id="<?php echo $image[2]; ?>"> Delete Image </button>
                    </form>
                    <?php }
                    else 
