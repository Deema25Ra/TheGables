...
if (isset($_POST["signup"])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($statement = mysqli_prepare($connection, $sql)) {
            ...
            mysqli_stmt_bind_param($statement, "ssiidssss", $_POST["fname"], $_POST["lname"], $_POST["age"], $_POST["Family"], $_POST["income"], $_POST["job"], $_POST["phoneNumber"], $_POST["email"], $pass);
...
#Sign-up:hover{
 ...
 <label for="fname">First name:</label>
        <input id="fname" type="text" name="fname" value="" required><br>

        <label for="lname">Last name:</label>
        <input id="lname" type="text" name="lname" value="" required><br>

        <label for="Age">Age:</label>
        <input id="Age" type="number" name="age" value="" min="10" max="100" class="num" required><br>

       <label for="Family">Family member:</label>
       <input id="Family" type="number" name="Family" value="" min="0" max="30" class="num" required><br>

        <label for="income">Income:</label>
        <input id="income" type="number" name="income" value="" class="num" required><br>

        <label for="job">Job:</label>
        <input id="job" type="text" name="job" value="" required><br>

        <label for="phoneNumber">Phone number:</label>
        <input id="phoneNumber" type="text" name="phoneNumber" value="" class="num" required><br>

        <label for="email">Email:</label>
        <input id="email" type="email" value="" name="email" required><br>
        ...
        <input id="password" type="password" name="password" value="" required><br>
                            ...
                            <div id="div-button">
                             ...
                             <button id="Sign-up" type="submit" name="signup">Sign-up</button>
