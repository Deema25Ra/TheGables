   ...
   //-----------------------------------------------------------------------
        ...
        if($propID>0){
          foreach($paths as $path){
            $AddImage ="INSERT INTO PropertyImage(property_id,path)VALUES($propID,'$path')";
    ...
    <div class="container">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <label><br> <span>Picture:</span>
                <input type="file" name="picture[]" class="Pinfo" accept="image/*" style="font-family: Papyrus;" multiple>
            </label><br>
